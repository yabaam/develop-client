...
const HomeGigsView: FC<IHomeProps> = (): ReactElement => {
  return (
      ...
      <div className="flex items-center px-6 py-6 sm:items-start">
        <div className="flex w-full flex-col justify-between">
          <div className="flex flex-col gap-2 md:flex-row">
            <h2 className="flex self-center text-base font-bold md:text-lg lg:text-2xl"></h2>
          ...
          <h4 className="pt-1 text-center text-sm sm:text-left">Promociones que te gustaran</h4>
        </div>
      </div>
